 ...
 *
 * _coder_init_LP_1028_api.c
 *
 * Code generation for function '_coder_init_LP_1028_api'
 *
 */
...
void init_LP_1028_api(const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
...
/* End of code generation (_coder_init_LP_1028_api.c) */
