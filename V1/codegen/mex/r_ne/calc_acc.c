...
void calc_acc(const emlrtStack *sp, real_T LP_num_q, const char_T LP_J_type[21],
              const real_T LP_BB[21], const real_T LP_cc[1323],
      ...
      if (b_idx_1 == 0.0) {
        ...
        for (i1 = 0; i1 < 3; i1++) {
          ...
          if (((int32_T)d1 < 1) || ((int32_T)d1 > 63)) {
            emlrtDynamicBoundsCheckR2012b((int32_T)d1, 1, 63, &pb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
        ...
        if (LP_J_type[b_i] == 'R') {
          ...
          if ((b_idx_1 < 1.0) || (b_idx_1 > 21.0)) {
            emlrtDynamicBoundsCheckR2012b((int32_T)b_idx_1, 1, 21, &gb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          c_SV = SV->qdd[b_i];
          ...
          i2 = (int32_T)b_idx_1;
          if ((i2 < 1) || (i2 > 21)) {
            emlrtDynamicBoundsCheckR2012b(i2, 1, 21, &jb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          i2 = (int32_T)b_idx_1;
          i2 = 3 * (i2 - 1) + 63 * b_i;
          ...
          i2 = (int32_T)b_idx_1;
          if ((i2 < 1) || (i2 > 21)) {
            emlrtDynamicBoundsCheckR2012b(i2, 1, 21, &mb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          i2 = (int32_T)b_idx_1;
          ...
          i2 = (int32_T)b_idx_1;
          if ((i2 < 1) || (i2 > 21)) {
            emlrtDynamicBoundsCheckR2012b(i2, 1, 21, &ib_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          /* CROSS	Vector cross product */
          /*  */
          ...
          i2 = (int32_T)b_idx_1;
          if ((i2 < 1) || (i2 > 21)) {
            emlrtDynamicBoundsCheckR2012b(i2, 1, 21, &lb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          /* CROSS	Vector cross product */
          /*  */
          ...
          i2 = (int32_T)b_idx_1;
          if ((i2 < 1) || (i2 > 21)) {
            emlrtDynamicBoundsCheckR2012b(i2, 1, 21, &kb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          /* CROSS	Vector cross product */
          /*  */
          ...
          if ((b_idx_1 < 1.0) || (b_idx_1 > 21.0)) {
            emlrtDynamicBoundsCheckR2012b((int32_T)b_idx_1, 1, 21, &hb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          i2 = (int32_T)b_idx_1;
          if ((i2 < 1) || (i2 > 21)) {
            emlrtDynamicBoundsCheckR2012b((int32_T)b_idx_1, 1, 21, &nb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          A_I_BB_tmp = 3 * (i2 - 1);
          ...
          i2 = (int32_T)b_idx_1;
          if (i2 != i1) {
            emlrtIntegerCheckR2012b(b_idx_1, &cb_emlrtDCI, (emlrtConstCTX)sp);
          }
          /* CROSS	Vector cross product */
          /*  */
          /* 	CROSS(V1, V2) returns the vector cross product V1 x V2 */
          ...
          if (i2 != i1) {
            emlrtIntegerCheckR2012b(b_idx_1, &bb_emlrtDCI, (emlrtConstCTX)sp);
          }
          /* CROSS	Vector cross product */
          /*  */
          /* 	CROSS(V1, V2) returns the vector cross product V1 x V2 */
